                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="cust_phone" maxlength="10" pattern="[0-9]{10}" placeholder="10 digits" value="<?php if(isset($_POST['cust_phone'])){echo $_POST['cust_phone'];} ?>">
                                </div>
